  ...
  return (
    <div className="app">
      ...
      <main className="main">
        ...
        {view === 'chat' && (
          <Chat groups={myGroups} activeChat={activeChat} chatGroupId={chatGroupId} setChatGroupId={setChatGroupId} sendMessage={sendMessage} sendingMessage={sendingMessage} currentUser={auth} />
        )}
